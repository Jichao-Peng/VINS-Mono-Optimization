...
class Estimator
{
  public:
    ...
    void processImage(const map<int, vector<pair<int, Eigen::Matrix<double, 7, 1>>>> &image, const map<int, vector<pair<int, Eigen::Matrix<double, 4, 1>>>> &line_image, const std_msgs::Header &header);
    ...
    double para_Td[1][1];
    double para_Tr[1][1];
    double para_Line[NUM_OF_L][SIZE_LINE]; // line feature params 5
