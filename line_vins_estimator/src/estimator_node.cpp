...
void process()
{
    while (true)
    {
        ...
        for (auto &measurement : measurements)
        {
            ...
            map<int, vector<pair<int, Eigen::Matrix<double, 4, 1>>>> line_image;
            ...
            {
                int v = img_msg->channels[5].values[i]+0.5;
                int line_feature_id = v / NUM_OF_CAM;
                int camera_id = v % NUM_OF_CAM;
                ...
                Eigen::Matrix<double, 4, 1> start_end_points;
                start_end_points << start_x, start_y, end_x, end_y;
                line_image[line_feature_id].emplace_back(camera_id, start_end_points);
            }
...
int main(int argc, char **argv)
{
    ...
    ros::Subscriber sub_restart = n.subscribe("/line_feature_tracker/restart", 2000, restart_callback);
